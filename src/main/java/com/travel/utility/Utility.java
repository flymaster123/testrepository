...
{
    public static String leadingZeros(final String s, final int length) {
        if (s.length() >= length) {
            return s;
        }
    ...
    public static String googleDateformat(final String orgDate) {
        String fomateDate = "";
        final String[] format = orgDate.split("-");
        fomateDate = String.valueOf(format[1]) + "/" + format[2] + "/" + format[0];
        return fomateDate;
    }
    
    public static String timeConversion(final int totalSeconds) {
        final int MINUTES_IN_AN_HOUR = 60;
        final int SECONDS_IN_A_MINUTE = 60;
        final int minutes = totalSeconds % 60;
        final int totalhr = totalSeconds / 60;
        final int hr = totalhr % 60;
        return String.valueOf(hr) + "h " + minutes + "m";
    }
    
    public static HashMap<String, String> getAirlines() {
        final HashMap<String, String> airline = new HashMap<String, String>();
        ...
        final HashMap<String, String> sortedMap = sortHashMapByValues(airline);
        return sortedMap;
    }
    
    public static LinkedHashMap<String, String> sortHashMapByValues(final HashMap<String, String> passedMap) {
        final List<String> mapKeys = new ArrayList<String>(passedMap.keySet());
        final List<String> mapValues = new ArrayList<String>(passedMap.values());
        ...
        for (final String val : mapValues) {
            ...
            while (keyIt.hasNext()) {
                ...
                final String comp1 = passedMap.get(key);
                final String comp2 = val;
    ...
    public static Integer getCabinId(final String cabinType) {
        final HashMap<String, Integer> cabinClass = new HashMap<String, Integer>();
    ...
    public static String getCabin(final int cabinType) {
        final HashMap<Integer, String> cabinClass = new HashMap<Integer, String>();
    ...
    public static int getDayDiff(final String date1, final String date2) {
        final SimpleDateFormat myFormat = new SimpleDateFormat("MM/dd/yyyy");
    ...
    public static String getDayHHMMDiff(final Date startDate, final Date endDate) {
        final SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy/HH:mm:ss");
        final long diffInMilliSec = endDate.getTime() - startDate.getTime();
        final long seconds = diffInMilliSec / 1000L % 60L;
        final long minutes = diffInMilliSec / 60000L % 60L;
        final long hours = diffInMilliSec / 3600000L % 24L;
        final long days = diffInMilliSec / 86400000L % 365L;
        String res = "";
        if (days > 0L) {
            res = String.valueOf(days) + " Days ";
        }
        if (hours > 0L) {
            res = String.valueOf(res) + hours + " Hours ";
        }
        if (minutes > 0L) {
            res = String.valueOf(res) + minutes + " Minutes ";
        }
        return res;
    }
    
	public static void localeResolver(final HttpServletRequest request, final HttpServletResponse response, final String countryCode, final String langauge) {
        final LocaleResolver localeResolver = RequestContextUtils.getLocaleResolver(request);
        final Locale locale = new Locale(langauge, countryCode);
