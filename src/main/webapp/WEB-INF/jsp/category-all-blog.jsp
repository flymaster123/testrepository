...
<body>
    ...
    <!-- <div class="blog-head">
        ...
        <div class="blogtop-banner">  
            <img src="/resources/images/blog-banner.jpg" alt="blog-banner" width="10" height="2" loading="lazy" decoding="async">
            <h1>${cat} Blog</h1>
        </div>
    ...
    <div class="blog-items-container">
        ...
        <div class="blog-items">
            <!-- <h1>Our Blog</h1> -->
            <c:forEach var="blll" items="${allBlogs}" >
            <div class="bitem">
                <div class="bimg">
                    <!-- <img src="/resources/images/blog/${blll.titleUrl}-sm.jpg"> -->
                    <!-- <a href="/blogs/${blll.titleUrl}"><img src="/resources/images/blog/blog-main/${blll.titleUrl}-sm.jpg" alt="blog-dummy" width="10" height="6" loading="lazy" decoding="async"></a> --> 
                    ...
                    <c:choose>
							...
							<c:otherwise>
								<a href="/blogs/${blll.titleUrl}"><img
									src="/resources/images/blog/blog-dummyimg.webp" alt="blog-dummy"
                    ...
                    <%-- <a href="/blogs/${blll.titleUrl}"><img src="/resources/images/blog/blog-dummyimg.webp" alt="blog-dummy" width="10" height="6" loading="lazy" decoding="async"></a> --%>
                </div>
                <div class="bmtxt">
        ...
        <!-- <div class="load-more-btn">
            <a href="#" class="loadmoreblogs">Load More</a>
        </div> -->
