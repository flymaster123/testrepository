   ...
   <jsp:include page="header.jsp" />
    ...
    <div class="contactus">
        ...
        <div class="contact-form">
            <h3>Image Form</h3>
			<span>Please Upload Image with correct name to get reflect in page</span>
            <form:form modelAttribute="imageForm" action="/image/submit" method="post" enctype="multipart/form-data">
                <div class="flname">
                    <div><label>Image Type</label><br>
                ...
                <div class="phonemail">
                    <div><label>Upload Image</label><br><form:input type="file" path="file" accept="image/x-png,image/gif,image/jpeg" /></div>
